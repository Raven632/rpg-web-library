...
![Скриншот интерфейса](https://via.placeholder.com/1000x500.png?text=Тут+будет+твой+скриншот+сайта)
...
1. Клонируйте репозиторий:
   ```bash
   git clone [https://github.com/твой-ник/rpg-library.git](https://github.com/твой-ник/rpg-library.git)
   cd rpg-library

2. Запустите контейнер: docker compose up -d --build
